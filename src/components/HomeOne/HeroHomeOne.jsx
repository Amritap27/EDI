        ...
        <div className="container">
            <div className="banner__image">
                ...
                <div className="banner__content animated-content">
                    ...
                    <h4 className="mb-2" data-animation="fadeInLeft" data-duration="1s" data-delay=".1s">INNOVATE YOUR HOME</h4>
                    <h1 data-animation="fadeInLeft" data-duration="1.5s" data-delay=".15s">Planning, Design, Interiors, Urban Development</h1>
