...
import logo1 from '../../assets/images/edi-imgs/EDI_Name_Plate.png';
// import DarkLogo from './assets/images/logo/logo-light.png';
import SidebarLogo from '../../assets/images/edi-imgs/EDI_Name_Plate.png';
          ...
          <div className="header-top__wrp">
            ...
            <ul className="header-top__links">
              <li>
                ...
                <Link to="#0">EDI Pvt. Ltd. Kalimati, Kathmandu, Nepal</Link>
              </li>
              <li>
          ...
          <div className="sidebar__contact-info mt-30">
            ...
            <ul>
              <li>
                ...
                <Link to="#0">121 King Street, Melbourne</Link>
              </li>
              <li className="py-2">
                <i className="fa-solid fa-phone-volume"></i>{' '}
                <Link to="tel:+912659302003">+91 2659302 003</Link>
              </li>
              <li>
                <i className="fa-solid fa-paper-plane"></i>{' '}
                <Link to="#0">info.company@gmail.com</Link>
              </li>
            </ul>
          </div>
