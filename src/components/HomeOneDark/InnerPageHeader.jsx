        ...
        <div className="container">
            <div className="header-top__wrp">
                ...
                <ul className="header-top__links">
                    ...
                    <li><i className="fa-light fa-envelope-open-text"></i> <Link to="#0">info.company@gmail.com</Link></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <div className="offcanvas-body sidebar__body">
            ...
            <div className="sidebar__contact-info mt-30">
                ...
                <ul>
                    ...
                    <li className="py-2"><i className="fa-solid fa-phone-volume"></i> <Link to="tel:+912659302003">+91 2659302 003</Link></li>
