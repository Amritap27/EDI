    ...
    <ul className="mobile-menu">
      ...
      <li>
        <a href="#0" onClick={() => handleToggle('services')}>
          ...
          <i
            className={`fa-solid ${
              activeMenu === 'services' ? 'fa-angle-up' : 'fa-angle-down'
            }`}
          ></i>
        </a>
        <ul
          className={`sub-menu ${
            activeMenu === 'services' ? 'd-block' : 'd-none'
          }`}
        >
          <li>
            <Link to="/page-services">Service Grid</Link>
          </li>
          <li>
            <Link to="/page-service-details">Service Details</Link>
          </li>
        </ul>
      </li>
      <li>
        <a href="#0" onClick={() => handleToggle('pages')}>
          ...
          <i
            className={`fa-solid ${
              activeMenu === 'pages' ? 'fa-angle-up' : 'fa-angle-down'
            }`}
          ></i>
        </a>
        <ul
          className={`sub-menu ${
            activeMenu === 'pages' ? 'd-block' : 'd-none'
          }`}
        >
          <li>
            <Link to="/contact">Contact V1</Link>
          </li>
          <li>
      ...
      <li>
        <a href="#0" onClick={() => handleToggle('blog')}>
          ...
          <i
            className={`fa-solid ${
              activeMenu === 'blog' ? 'fa-angle-up' : 'fa-angle-down'
            }`}
          ></i>
        </a>
        <ul
          className={`sub-menu ${activeMenu === 'blog' ? 'd-block' : 'd-none'}`}
        >
          <li>
